...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        if dataset in ['refcoco', 'refcoco+', 'refcocog']:
            self.IMAGE_DIR = "/projects/tir6/bisk/yingshac/MLVM/MSCOCO/train2014"#osp.join(data_root, 'images/mscoco/images/train2014')
    ...
    def showRef(self, ref, seg_box='seg'):
        ...
        I = Image.open(osp.join(self.IMAGE_DIR, image['file_name'])).convert('RGB')# io.imread(osp.join(self.IMAGE_DIR, image['file_name']))
        ax.imshow(I)
...
if __name__ == '__main__':
    ...
    for ref_id in ref_ids:
        ...
        if len(ref['sentences']) < 2: continue
